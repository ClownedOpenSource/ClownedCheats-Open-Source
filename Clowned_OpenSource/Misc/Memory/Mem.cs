namespace Clowned_OpenSource.Misc.Memory
{
    ...
    public partial class UpdatedM3m0ry
    {
    ...
    Int32 dwProcessId
        ...
        public static Process theProc = null;
        ...
        public bool WriteMemory(string code, string type, string write, string file = "", bool useDirty = true, System.Text.Encoding stringEncoding = null, bool RemoveWriteProtection = true)
        {
            byte[] memory = new byte[4];
            int size = 4;
            ...
            else if (type.ToLower() == "custom_string")
            {
                var bytes = System.Text.Encoding.UTF8.GetBytes(write);
                if (useDirty) Array.Resize(ref bytes, write.Length * 2);
                WriteProcessMemory(Handle, theCode, bytes, (UIntPtr)bytes.Length, IntPtr.Zero);
            }
        ...
        /// <summary>
        /// Write String array to addresses.
        /// </summary>
        /// <param name="code">address to write to</param>
        /// <param name="text">byte array to write</param>
        /// <param name="file">path and name of ini file. (OPTIONAL)</param>
